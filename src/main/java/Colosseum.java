...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        tempPokemon.hitPoints = s.nextInt();
        ...
        tempPokemon.attackLevel = s.nextInt();
        ...
        tempPokemon.defenseLevel = s.nextInt();
        while (tempPokemon.defenseLevel < 1 || tempPokemon.defenseLevel > (50 - tempPokemon.attackLevel)) {
            System.out.println("Sorry. The attack level must be between 1 and "+ (50 - tempPokemon.attackLevel) + ": ");
            tempPokemon.defenseLevel = s.nextInt();
        }
        return tempPokemon;
    }
    ...
    public static void determineWinner() {
        ...
        } else if (firstPokemon.hitPoints < 1) {
